                ...
                [
                    ...
                    'value' => function ($data) {
                        return '<b>' . $data->resident->apartment->housingEstate->name . '</b>'
                                . ' - ' . $data->resident->apartment->name. '</b>'
                                . ' - ' . $data->resident->name;
                    },
                ],
                'description',
