...
if (\Yii::$app->user->can('/housing-estate/*')) {
    $template = '{view}  {update}  {delete}';
}
?>
<div class="housing-estate-index box box-primary">
    <div class="box-header with-border">
    <?php  if (\Yii::$app->user->can('/housing-estate/create')) :  ?> 
        <?= Html::a('<i class="flaticon-add" style="font-size: 20px"></i> '.'Crear Housing Estate', ['create'], ['class' => 'btn btn-primary']) ?>
    <?php  endif;  ?> 
    </div>
