...
insert  into `auth_assignment`(`item_name`,`user_id`,`created_at`) values ('ClienteAPI','2',1572374414),('Portero','3',1589816745),('Portero','4',1589816739),('SuperAdministrador','1',1570722074),('Supervisor','5',1589919245);
...
insert  into `auth_item_child`(`parent`,`child`) values ('ApiClient','/api/*'),('ApiClient','/api/index'),('ApiClient','/api/options'),('ApiClient','/api/view'),('ClienteAPI','ApiClient'),('fullPermission','/*'),('SuperAdministrador','fullPermission'),('supervisar','/housing-estate-security-guard/*'),('supervisar','/housing-estate-security-guard/create'),('supervisar','/housing-estate-security-guard/delete'),('supervisar','/housing-estate-security-guard/index'),('supervisar','/housing-estate-security-guard/update'),('supervisar','/housing-estate-security-guard/view'),('supervisar','/security-guards/*'),('supervisar','/security-guards/create'),('supervisar','/security-guards/delete'),('supervisar','/security-guards/index'),('supervisar','/security-guards/update'),('supervisar','/security-guards/view'),('supervisar','/site/*'),('Supervisor','supervisar');
...
CREATE TABLE `cards` (
  `code` varchar(20) NOT NULL COMMENT 'Código',
  ...
  CONSTRAINT `fk_cards_residents1` FOREIGN KEY (`resident_id`) REFERENCES `residents` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `cards` */

insert  into `cards`(`code`,`resident_id`,`description`,`active`,`created`,`created_by`,`modified`,`modified_by`) values ('abc123',1,'Acceso para Felipe Echeverri ',1,'2020-06-01 09:17:28','admin','2020-06-01 09:19:43','admin');

/*Table structure for table `cards_log` */

DROP TABLE IF EXISTS `cards_log`;
...
DROP TABLE IF EXISTS `housing_estate_security_guard`;

CREATE TABLE `housing_estate_security_guard` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `housing_estate_id` int(11) NOT NULL COMMENT 'Unidad residencial',
...
insert  into `menu`(`id`,`name`,`parent`,`route`,`order`,`data`) values (1,'U. residenciales',NULL,'/housing-estate/index',1,' flaticon-map-location'),(2,'Ciudades',9,'/cities/index',3,' flaticon-placeholder-2'),(3,'Apartamentos',NULL,'/apartments/index',2,' fa-building'),(4,'Residentes',NULL,'/residents/index',3,' flaticon-users'),(5,'Mascotas',NULL,'/pets/index',5,' fa-paw\r\n'),(6,'Vehículos',NULL,'/vehicles/index',6,' fa-car'),(7,'Administradores',NULL,'/administrators/index',7,' flaticon-profile'),(8,'Puertas',NULL,'/gates/index',8,' flaticon-interface'),(9,'Configuración',NULL,NULL,11,' flaticon-cogwheel'),(10,'Usuarios',9,'/users/index',1,' flaticon-users'),(11,'Asignaciones',9,'/admin/assignment/index',3,' flaticon-user-ok'),(12,'Autorización de acceso',9,'/authorizations/index',4,' flaticon-lock-1'),(13,'Cámaras',NULL,'/security-cameras/index',8,' fa-camera'),(14,'Asignar porteros',9,'/security-guards/index',NULL,' flaticon-profile-1'),(15,'Tarjetas de acceso',NULL,'/cards/index',4,' flaticon-lock'),(16,'Logs',NULL,NULL,10,' flaticon-clipboard'),(17,'Porterías',16,'/gates-logs/index',1,' flaticon-clipboard'),(18,'Tarjetas de acceso',16,'/cards-log/index',2,' flaticon-clipboard');
...
insert  into `pets`(`id`,`apartment_id`,`name`,`description`,`photo`,`type`,`created`,`created_by`,`modified`,`modified_by`) values (1,1,'Pipo','Perro negro','archivos/20191021194644-descarga.jpg',1,'2019-10-21 14:46:44','admin','2019-10-21 14:46:44','admin'),(2,2,'sad','asds','archivos/20200505210351-foto.jpg',1,'2020-05-05 16:03:34','admin','2020-05-05 16:03:51','admin');
...
CREATE TABLE `security_guards` (
  ...
  `active` tinyint(1) NOT NULL COMMENT 'Activo',
  `created` datetime NOT NULL COMMENT 'Creado',
  `created_by` varchar(50) CHARACTER SET latin1 NOT NULL COMMENT 'Creado por',
  `modified` datetime NOT NULL COMMENT 'Modificado',
  `modified_by` varchar(50) CHARACTER SET latin1 NOT NULL COMMENT 'Modificado por',
