...
insert  into `auth_assignment`(`item_name`,`user_id`,`created_at`) values ('ClienteAPI','2',1572374414),('Portero','3',1589816745),('Portero','4',1589816739),('SuperAdministrador','1',1570722074);
...
insert  into `housing_estate_security_guard`(`id`,`housing_estate_id`,`security_guard_id`) values (13,1,5),(14,2,5),(15,1,6),(17,1,7),(18,2,7);
...
insert  into `security_guards`(`id`,`active`,`created`,`created_by`,`modified`,`modified_by`,`user_id`) values (5,1,'2020-05-18 13:56:21','admin','2020-05-18 14:16:24','admin',3),(7,1,'2020-05-19 14:21:49','admin','2020-05-19 14:22:02','admin',4);
